...
@GenCreateRequest(pkgName = "com.bantanger.api.template.selectdict.request", sourcePath = GenSourceConstants.GEN_API_SOURCE_MAC)
@GenUpdateRequest(pkgName = "com.bantanger.api.template.selectdict.request", sourcePath = GenSourceConstants.GEN_API_SOURCE_MAC)
@GenQueryRequest(pkgName = "com.bantanger.api.template.selectdict.request", sourcePath = GenSourceConstants.GEN_API_SOURCE_MAC)
@GenResponse(pkgName = "com.bantanger.api.template.selectdict.response", sourcePath = GenSourceConstants.GEN_API_SOURCE_MAC)
