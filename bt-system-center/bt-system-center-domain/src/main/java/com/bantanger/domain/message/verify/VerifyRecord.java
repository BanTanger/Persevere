...
@GenCreateRequest(pkgName = "com.bantanger.api.message.verify.request", sourcePath = GenSourceConstants.GEN_API_SOURCE)
@GenUpdateRequest(pkgName = "com.bantanger.api.message.verify.request", sourcePath = GenSourceConstants.GEN_API_SOURCE)
@GenQueryRequest(pkgName = "com.bantanger.api.message.verify.request", sourcePath = GenSourceConstants.GEN_API_SOURCE)
@GenResponse(pkgName = "com.bantanger.api.message.verify.response", sourcePath = GenSourceConstants.GEN_API_SOURCE)
