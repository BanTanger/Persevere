...
@GenCreateRequest(pkgName = "com.bantanger.api.asset.asset.request", sourcePath = GenSourceConstants.GEN_API_SOURCE)
@GenUpdateRequest(pkgName = "com.bantanger.api.asset.asset.request", sourcePath = GenSourceConstants.GEN_API_SOURCE)
@GenQueryRequest(pkgName = "com.bantanger.api.asset.asset.request", sourcePath = GenSourceConstants.GEN_API_SOURCE)
@GenResponse(pkgName = "com.bantanger.api.asset.asset.response", sourcePath = GenSourceConstants.GEN_API_SOURCE)
